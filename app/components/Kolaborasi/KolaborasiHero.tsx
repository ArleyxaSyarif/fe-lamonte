            ...
            <div className="max-w-screen-2xl mx-auto relative z-10 px-0">
                ...
                <div className="mb-16 md:mb-20 text-center md:text-left max-w-4xl">
                    <ScrollReveal delay={0}>
                        <div className="inline-flex items-center gap-3 px-4 py-2 bg-[#ffaa00]/5 rounded-xl border border-[#ffaa00]/10 shadow-sm backdrop-blur-md mb-6">
                            <span className="material-symbols-outlined text-[#ffaa00] text-sm" style={{ fontVariationSettings: "'FILL' 1" }}>insights</span>
                    ...
                    <ScrollReveal delay={400}>
                        <div className="mt-8 h-1 w-24 bg-[#ffaa00] mx-auto md:mx-0 opacity-50 shadow-sm"></div>
                    </ScrollReveal>
                </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
                    ...
                    <div className="lg:col-span-7 space-y-12 md:space-y-16">
                            ...
                            <ScrollReveal key={idx} delay={300 + idx * 150}>
                                <div className="group">
                                    <div className="flex items-start gap-4 md:gap-6">
                                        <span className="font-poppins text-5xl md:text-6xl font-black text-[#ffaa00]/20 transition-colors group-hover:text-[#ffaa00] leading-none shrink-0">
                                            {item.step}
                                        </span>
                                        <div>
                                            <h3 className="font-poppins text-xl md:text-2xl font-black text-[#1a1c1a] mb-2 md:mb-3">{item.title}</h3>
                                            <p className="font-poppins text-[#1a1c1a]/60 text-base md:text-lg leading-relaxed max-w-xl">
                                                {item.desc}
                                            </p>
                                        </div>
                                    </div>
                        ...
                        <ScrollReveal delay={800}>
                            <div className="mt-16 md:mt-20 p-6 md:p-8 bg-white rounded-xl border-l-4 border-[#ffaa00] shadow-sm relative overflow-hidden group">
                                <div className="relative z-10">
                                    <h4 className="font-poppins text-lg md:text-xl font-bold text-[#1a1c1a] mb-2 font-black">Eksklusivitas Wilayah Terbatas</h4>
                                    <p className="font-poppins text-[#1a1c1a]/70 leading-relaxed text-sm md:text-base">
                                ...
                                <span className="material-symbols-outlined absolute -right-4 -bottom-4 text-8xl md:text-9xl text-[#ffaa00]/10 rotate-12 group-hover:rotate-6 transition-transform duration-500" style={{ fontVariationSettings: "'FILL' 1" }}>verified_user</span>
                            </div>
                        </ScrollReveal>
                    ...
                    <div className="lg:col-span-5 lg:sticky lg:top-32">
                        <ScrollReveal delay={500}>
                            <div className="bg-[#232722] p-8 md:p-10 rounded-[2rem] shadow-2xl relative overflow-hidden backdrop-blur-md">
                                <div className="absolute top-0 right-0 w-32 h-32 bg-[#ffaa00] opacity-10 rounded-bl-full"></div>

                                <div className="flex items-center gap-4 mb-10 relative z-10">
                                    <span className="material-symbols-outlined text-[#ffaa00] text-4xl" style={{ fontVariationSettings: "'FILL' 1" }}>menu_book</span>
                                    <h2 className="font-poppins text-2xl md:text-3xl font-black text-white">Panduan Reservasi</h2>
                                </div>
                                ...
                                <div className="space-y-8 md:space-y-10 relative z-10">
                                    {[
                                        ...
                                        <div key={idx} className="flex gap-4 md:gap-5 group">
                                            <div className="font-poppins flex-shrink-0 w-8 h-8 rounded-full bg-[#ffaa00] flex items-center justify-center text-[#232722] font-black text-sm shadow-md transition-transform duration-300 group-hover:scale-110">
                                                {step.step}
                                            </div>
                                            <div>
                                                <h4 className="font-poppins text-base md:text-lg font-black text-white mb-1">{step.title}</h4>
                                                <p className="font-poppins text-white/70 text-sm md:text-base leading-relaxed">{step.desc}</p>
                                            </div>
                                        </div>
                                    ))}
                                </div>

                                <a href="#paket" className="font-poppins mt-12 w-full bg-[#ffaa00] text-[#232722] py-4 md:py-5 rounded-xl font-bold text-base md:text-lg hover:bg-[#ffaa00]/90 transition-all flex items-center justify-center gap-3 active:scale-95 group shadow-xl relative z-10 text-center">
                                    <span>Lanjut Pilih Paket Kemitraan</span>
                                    <span className="material-symbols-outlined text-[#232722] group-hover:translate-x-1 transition-transform">arrow_forward</span>
                                </a>

                                <p className="font-poppins mt-8 text-center text-[10px] md:text-xs font-bold tracking-[0.3em] text-white/50 uppercase relative z-10">
