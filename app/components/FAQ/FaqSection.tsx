...
export default function FaqSection() {
    return (
        <section className="relative bg-[#fffbeb] py-24 px-6 md:px-12 lg:px-24 font-poppins overflow-hidden">

            {/* Dots Pattern Background - Green Accent */}
            <div
                className="absolute inset-0 z-0 opacity-[0.05] pointer-events-none"
                style={{
                    backgroundImage: `radial-gradient(#005911 2px, transparent 2px)`,
            ...
            <div className="relative z-10 max-w-4xl mx-auto">
                ...
                <div className="text-center mb-20">
                    <ScrollReveal delay={0}>
                        <span className="font-poppins text-sm tracking-[0.3em] uppercase text-[#1a1c1a] mb-4 block font-bold opacity-70">
                            Bantuan & Informasi
                        </span>
                    </ScrollReveal>
                    ...
                    <ScrollReveal delay={200}>
                        <h2 className="font-poppins text-4xl md:text-5xl text-[#1a1c1a] mb-6 font-black tracking-tight">
                            Pertanyaan <span className="text-[#005911]">Calon Mitra</span>
                        </h2>
                    </ScrollReveal>

                    <ScrollReveal delay={400}>
                        <p className="text-[#1a1c1a]/70 max-w-xl mx-auto leading-relaxed">
                            Menjawab segala keraguan Anda untuk melangkah bersama Lamonte membangun bisnis keluarga yang berkah.
                        </p>
                    </ScrollReveal>

                    <div className="mt-10 flex justify-center">
                        <div className="h-[2px] w-24 bg-[#005911]"></div>
                    </div>
                </div>
                ...
                <div className="space-y-6">
                    {FAQS.map((faq, idx) => (
                        <ScrollReveal key={faq.id} delay={600 + idx * 100}>
                            <div
                                className="relative bg-white rounded-2xl overflow-hidden border border-[#005911]/5 hover:border-[#005911]/20 transition-all duration-300 shadow-sm hover:shadow-md"
                            >
                                ...
                                <details className="group p-6 md:p-10">
                                    <summary className="flex items-center justify-between cursor-pointer list-none">
                                        ...
                                        <div className="bg-[#005911]/5 p-2 rounded-full shadow-inner group-hover:bg-[#005911]/10">
                                            <span className="material-symbols-outlined expand-icon text-[#005911] transition-transform duration-500 text-3xl">
                                                expand_more
                                            </span>
                                        </div>
                                    </summary>
                                    <div className="mt-8 pt-8 border-t border-[#005911]/5">
                                        <p className="text-[#1a1c1a]/70 leading-relaxed text-base md:text-lg">
                                            {faq.answer}
                                        </p>
                                    </div>
                                </details>
                ...
                <ScrollReveal delay={1000}>
                    <div className="mt-20 p-12 bg-white/60 backdrop-blur-md rounded-[3rem] text-center border border-[#005911]/5 shadow-[0_20px_50px_-12px_rgba(0,89,17,0.05)] relative overflow-hidden">
                        <div className="absolute top-0 right-0 w-32 h-32 bg-[#005911]/5 rounded-bl-full -mr-16 -mt-16 pointer-events-none" />
                        <h4 className="font-poppins text-2xl text-[#1a1c1a] mb-4 font-black">
                            Masih Punya <span className="text-[#005911]">Pertanyaan Lain?</span>
                        </h4>
                        <p className="text-[#1a1c1a]/70 mb-8">
                        ...
                        <button
                            ...
                            className="inline-flex items-center justify-center gap-3 bg-[#005911] text-[#fffbeb] px-6 md:px-10 py-4 rounded-full font-bold text-xs md:text-sm hover:scale-[1.02] hover:shadow-xl hover:shadow-[#005911]/20 transition-all active:scale-95 w-full sm:w-auto font-poppins uppercase tracking-widest"
                        >
