...
export default function CTA() {
    return (
        <div className="w-full bg-white py-10">
            <section className="relative w-full max-w-6xl mx-auto py-20 px-6 rounded-[3rem] bg-[#1a3c04] overflow-hidden">
                ...
                <div className="absolute top-8 left-8 w-12 h-12 md:w-16 md:h-16 pointer-events-none opacity-20">
                    <svg className="text-[#fefae6]" fill="none" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="relative z-10 flex flex-col items-center text-center max-w-4xl mx-auto">
                    ...
                    <div className="mb-8 flex items-center gap-4">
                        <div className="h-px w-8 md:w-12 bg-[#fefae6]/30"></div>
                        <span className="font-body text-[10px] md:text-xs uppercase tracking-[0.3em] text-[#f4e04d] font-bold">
                    ...
                    {/* Main Title */}
                    <h2 className="font-headline text-2xl md:text-5xl lg:text-7xl text-[#fefae6] mb-8 leading-[1.1] tracking-tight">
                        Ayok <span className="italic font-normal text-[#f4e04d]">klik tombol</span> di bawah ini
                    </h2>

                    {/* Description Text */}
                    <p className="font-body text-sm md:text-xl text-[#fefae6]/80 mb-12 leading-relaxed max-w-2xl">
                    ...
                    <button
                        ...
                        className="group relative inline-flex items-center justify-center gap-3 md:gap-4 bg-[#f4e04d] text-[#1a3c04] px-8 md:px-10 py-4 md:py-5 rounded-full transition-all duration-500 hover:scale-[1.05] hover:shadow-2xl hover:shadow-[#f4e04d]/30 active:scale-95 w-full sm:w-auto shadow-xl"
                    >
                    ...
                    {/* Features List */}
                    <div className="mt-16 flex flex-wrap justify-center gap-x-10 gap-y-6 text-[#fefae6] opacity-60">
                        {[
                            "Free Konsultasi",
                            "Bimbingan Penjualan",
                            ...
                            <div key={index} className="flex items-center gap-3">
                                <div className="w-1.5 h-1.5 rounded-full bg-[#f4e04d]"></div>
