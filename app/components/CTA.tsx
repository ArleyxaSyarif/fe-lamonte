        ...
        <section className="font-poppins relative min-h-[700px] lg:min-h-[921px] flex items-center overflow-hidden bg-[#1a1c1a]">
            ...
            <div className="max-w-screen-2xl mx-auto px-6 md:px-12 relative z-20 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center w-full">
                ...
                <div className="lg:col-span-7 py-16">
                    <div className="mb-8 inline-flex items-center gap-2 px-4 py-1 rounded-full border border-[#c0cab9]/20 bg-white/5 backdrop-blur-sm">
                        <span className="w-2 h-2 rounded-full bg-[#ffddb4] shadow-[0_0_8px_#ffddb4]"></span>
                    ...
                    <h1 className="font-poppins font-black text-4xl md:text-6xl lg:text-7xl leading-[1.1] mb-8 tracking-tighter text-shadow-premium">
                        <span className="text-white">Ayok klik tombol</span><br />
                        <span className="text-[#519a66] italic">di bawah ini</span>
                    </h1>

                    <p className="font-poppins text-white/70 text-lg md:text-xl font-light leading-relaxed max-w-xl mb-12 border-l-2 border-[#694300]/40 pl-6">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-16">
                        {[
                            ...
                            <div key={idx} className="flex items-start gap-4">
                                <span className="material-symbols-outlined text-[#519a66] bg-white/5 p-2 rounded-lg">{item.icon}</span>
                                <div>
                    ...
                    <div className="flex flex-col sm:flex-row items-center gap-6">
                        <button
                            ...
                            className="font-poppins gold-glow group relative bg-gradient-to-r from-[#ffaa00] to-[#ffd786] text-[#291800] font-black text-sm md:text-lg px-8 md:px-10 py-4 md:py-5 rounded-xl hover:scale-105 active:scale-95 transition-all duration-300 w-full sm:w-auto flex items-center justify-center gap-3 shadow-xl"
                        >
                        ...
                        <div className="flex hidden sm:flex -space-x-3 items-center">
                            ...
                            <div className="w-10 h-10 rounded-full border-2 border-[#1a1c1a] bg-[#237227] flex items-center justify-center text-[10px] text-white font-bold font-poppins">+12 CS</div>
                        </div>
                    </div>
                </div>
                ...
                <div className="lg:col-span-5 hidden lg:block relative">
                    <div className="absolute -top-20 -right-20 w-64 h-64 bg-[#005911]/20 rounded-full blur-[100px]"></div>
                    <div className="relative bg-white/5 backdrop-blur-xl p-8 rounded-[2rem] border border-white/10 shadow-2xl">
                        <div className="flex justify-between items-start mb-8">
                            ...
                            <span className="material-symbols-outlined text-[#ffddb4] text-4xl">storefront</span>
                        </div>
                        <div className="space-y-6">
                            <div className="bg-[#1a1c1a]/50 p-5 rounded-2xl border border-white/5">
                                <div className="flex justify-between text-xs text-white/60 mb-3 font-poppins font-bold">
                                    ...
                                    <span className="text-[#519a66]">88%</span>
                                </div>
                                <div className="w-full bg-white/5 h-2 rounded-full overflow-hidden">
                                    <div className="bg-[#519a66] h-full w-[88%]"></div>
                                </div>
                            </div>
                            <div className="bg-[#1a1c1a]/50 p-5 rounded-2xl border border-white/5">
                                <div className="flex justify-between text-xs text-white/60 mb-3 font-poppins font-bold">
                                    <span>Tingkat Peminat</span>
                                    <span className="text-[#ffddb4]">Tinggi</span>
                                </div>
                                <div className="w-full bg-white/5 h-2 rounded-full overflow-hidden">
                                    <div className="bg-[#ffddb4] h-full w-[72%]"></div>
                                </div>
                            </div>
                        </div>
                        <div className="mt-8 pt-8 border-t border-white/5 flex items-center justify-between">
                            <p className="text-white font-poppins font-bold italic">Bergabung dengan 2.4k+ Mitra</p>
                            <span className="material-symbols-outlined text-[#ffddb4]/80">arrow_forward</span>
                        </div>
                    </div>
                </div>
            </div>
