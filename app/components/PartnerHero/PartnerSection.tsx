...
export default function PartnerSection() {
    ...
    return (
        <section
            id="partner"
            className="relative py-16 md:py-24 overflow-hidden bg-white font-poppins px-8"
        ...
        >
            ...
            <div
                ...
                style={{
                    backgroundImage: `radial-gradient(#1a1c1a 0.5px, transparent 0.5px)`,
                    backgroundSize: '24px 24px'
                }}
            ></div>

            <div className="w-full max-w-screen-2xl mx-auto relative z-10 px-0">
                {/* Header Row */}
                <div className="flex flex-col md:flex-row md:items-end justify-between mb-10 md:mb-16 gap-6 md:gap-8">
                    <div className="max-w-2xl">
                        <ScrollReveal delay={0}>
                            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-[#ffaa00]/10 text-[#ffaa00] text-[10px] font-poppins font-black tracking-[0.2em] uppercase mb-6 border border-[#ffaa00]/20">
                        ...
                        <ScrollReveal delay={200}>
                            <h2 className="text-3xl sm:text-4xl lg:text-6xl font-poppins font-black tracking-tight text-[#1a1c1a] leading-[1.1]">
                                Kenapa Bermitra <br className="hidden md:block" /> Dengan Kami?
                            </h2>
                        </ScrollReveal>
                    </div>
                    ...
                    <ScrollReveal delay={400}>
                        <div className="flex gap-3 md:gap-4 mb-2">
                            <button
                                ...
                                className="w-12 h-12 md:w-14 md:h-14 rounded-full border border-[#1a1c1a]/10 flex items-center justify-center bg-white shadow-sm hover:bg-[#f5f5f5] transition-colors group"
                            >
                            ...
                            <button
                                ...
                                className="w-12 h-12 md:w-14 md:h-14 rounded-full bg-[#ffaa00] flex items-center justify-center shadow-lg shadow-[#ffaa00]/20 hover:opacity-90 transition-opacity group"
                            >
                ...
                <div className="relative">
                        ...
                        {features.map((feat, i) => (
                            <div key={i} className="min-w-[85%] sm:min-w-[60%] md:min-w-[calc(50%-1rem)] lg:min-w-[calc(33.333%-1.5rem)] snap-start group/card">
                                <ScrollReveal delay={200 + (i * 100)}>
                                    <div className="flex flex-col h-auto min-h-[380px] md:h-[500px] md:min-h-0 bg-white rounded-[2rem] md:rounded-[2.5rem] p-6 sm:p-8 lg:p-10 shadow-[0_20px_50px_-12px_rgba(0,0,0,0.04)] border border-[#1a1c1a]/5 hover:border-[#ffaa00]/30 transition-all duration-500 hover:-translate-y-2 md:hover:-translate-y-4">
                                        ...
                                        <div className="flex-grow">
                                            ...
                                            <p className="text-[#1a1c1a]/60 font-poppins leading-relaxed text-sm md:text-lg mb-6 md:mb-8">{feat.desc}</p>
                                        </div>

                                        <div className="pt-5 md:pt-8 border-t border-[#1a1c1a]/5 flex items-center gap-2 mt-auto">
                                            <span className="material-symbols-outlined text-[#ffaa00] text-lg md:text-xl" style={{ fontVariationSettings: "'FILL' 1" }}>verified</span>
                                            <span className="text-[10px] md:text-xs font-poppins font-black tracking-widest uppercase text-[#ffaa00]">
                                                {feat.footer}
                                            </span>
                                        </div>
                                    </div>
                    ...
                    <div className="flex justify-center items-center gap-3 mt-4">
                        {Array.from({ length: 3 }).map((_, i) => (
                            <div
                                key={i}
                                className={`h-1.5 rounded-full transition-all duration-300 ${i === Math.floor(activeIndex / 2) ? 'w-10 bg-[#ffaa00]' : 'w-2 bg-[#ffaa00]/20'}`}
                            ></div>
                        ))}
                    </div>
                </div>
