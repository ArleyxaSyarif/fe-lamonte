        ...
        <main className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden bg-[#f5f1e8]">
            ...
            <div className="relative z-10 w-full max-w-6xl px-6 text-center pt-32 md:pt-20">
                ...
                <ScrollReveal delay={200}>
                    <h1 className="font-headline text-4xl md:text-7xl lg:text-8xl text-[#4c4033] font-bold mb-8 leading-[1.1] tracking-tight flex flex-col items-center gap-1">
                        <span>Buka Toko Baju</span>
                        <div className="h-12 md:h-16 flex items-center justify-center w-full mt-4">
                ...
                <ScrollReveal delay={400}>
                    <p className="max-w-2xl mx-auto text-md md:text-xl text-[#7d7168] leading-relaxed mb-10 md:mb-12 px-4 md:px-0">
                ...
                <ScrollReveal delay={600}>
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-4 md:gap-6">
                        <a href="#paket" className="w-full sm:w-auto group relative bg-[#967451] text-white px-8 md:px-10 py-4 md:py-5 rounded-full font-semibold flex items-center justify-center gap-3 transition-all duration-300 hover:scale-[1.02] active:scale-[0.98] shadow-lg shadow-[#967451]/20">
                            <span className="material-symbols-outlined">redeem</span>
                            <span>LIHAT PAKET & BONUS</span>
                        </a>
                        <a href="#video" className="w-full sm:w-auto bg-[#4c4033] text-white px-8 md:px-10 py-4 md:py-5 rounded-full font-semibold flex items-center justify-center gap-3 transition-all duration-300 hover:scale-[1.02] active:scale-[0.98] shadow-lg shadow-[#4c4033]/20">
